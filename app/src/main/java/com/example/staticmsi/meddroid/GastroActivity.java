...
public class GastroActivity extends Activity {
    ...
    private void setBtnToGen() {
        ...
        Button b = (Button) findViewById(R.id.btnToGeni);

        b.setOnClickListener(new BtnToGeniOnClick(this, this.pa.getId()));
    }

    class BtnToGeniOnClick implements View.OnClickListener {

        Long paId = null;
        GastroActivity ga;

        public BtnToGeniOnClick(GastroActivity ga, Long paId) {
            this.ga = ga;
            this.paId = paId;
        }
